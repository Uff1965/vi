...
// Define VI_CALL and VI_TM_API vvvvvvvvvvvvvv
...
// Definition of vi_tmGetTicks() function for different platforms. ^^^^^^^^^^^^
	...
	enum vi_tmReportFlags {
		vi_tmSortByTime		= 0b0000'0000,
		vi_tmSortByName		= 0b0000'0001,
		vi_tmSortBySpeed	= 0b0000'0010,
		vi_tmSortByAmount	= 0b0000'0011,
		vi_tmSortDescending	= 0b0000'0000,
		vi_tmSortAscending	= 0b0000'1000,
		vi_tmSortMask		= 0b0000'1111,

		vi_tmShowOverhead	= 0b0001'0000,
		vi_tmShowUnit		= 0b0010'0000,
		vi_tmShowDuration	= 0b0100'0000,
