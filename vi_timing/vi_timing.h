...
typedef struct vi_tm_journal_t *VI_TM_HJOURNAL;
...
// Main functions: vvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvvv
	...
	VI_TM_API VI_TM_HJOURNAL VI_TM_CALL vi_tmJournal(const char* name);
	VI_TM_API void VI_TM_CALL vi_tmWrite(VI_TM_HJOURNAL j, vi_tmTicks_t ticks, VI_STD(size_t) amount VI_DEF(1)) VI_NOEXCEPT;
