...
//		using ch::duration<double>::duration;
	...
	samples[] = {
#	define ITM(value, precition, dec, expected) {__LINE__, value, expected, precition, dec}
			ITM(  0.005'5, 1, 0,   0.006),
			ITM(  0.055'5, 1, 0,   0.060),
			ITM(  0.555'5, 1, 0,   0.600),
			ITM(  5.555'5, 1, 0,   6.000),
			ITM( 55.555'5, 1, 0,  60.000),
			ITM(555.555'5, 1, 0, 600.000),

			ITM(  0.005'5, 2, 0,   0.006),
			ITM(  0.055'5, 2, 0,   0.056),
			ITM(  0.555'5, 2, 0,   0.560),
			ITM(  5.555'5, 2, 0,   6.000),
			ITM( 55.555'5, 2, 0,  56.000),
			ITM(555.555'5, 2, 0, 560.000),

			ITM(  0.005'5, 3, 0,   0.006),
			ITM(  0.055'5, 3, 0,   0.056),
			ITM(  0.555'5, 3, 0,   0.556),
			ITM(  5.555'5, 3, 0,   6.000),
			ITM( 55.555'5, 3, 0,  56.000),
			ITM(555.555'5, 3, 0, 556.000),

			ITM(  0.005'555'5, 4, 0,   0.005'556),
			ITM(  0.055'555'5, 4, 0,   0.056'000),
			ITM(  0.555'555'5, 4, 0,   0.556'000),
			ITM(  5.555'555'5, 4, 0,   5.556'000),
			ITM( 55.555'555'5, 4, 0,  56.000'000),
			ITM(555.555'555'5, 4, 0, 556.000'000),

			ITM(  0.005'555'55, 5, 0,   0.005'556),
			ITM(  0.055'555'55, 5, 0,   0.055'556),
			ITM(  0.555'555'55, 5, 0,   0.556'000),
			ITM(  5.555'555'55, 5, 0,   5.556'000),
			ITM( 55.555'555'55, 5, 0,  55.556'000),
			ITM(555.555'555'55, 5, 0, 556.000'000),

			ITM(  0.005'555'5, 6, 0,   0.005'556),
			ITM(  0.055'555'5, 6, 0,   0.055'556),
			ITM(  0.555'555'5, 6, 0,   0.555'556),
			ITM(  5.555'555'5, 6, 0,   5.556'000),
			ITM( 55.555'555'5, 6, 0,  55.556'000),
			ITM(555.555'555'5, 6, 0, 555.556'000),

			ITM(  0.005'55, 2, 1,   0.005'6),
			ITM(  0.055'55, 2, 1,   0.056'0),
			ITM(  0.555'55, 2, 1,   0.560'0),
			ITM(  5.555'55, 2, 1,   5.600'0),
			ITM( 55.555'55, 2, 1,  56.000'0),
			ITM(555.555'55, 2, 1, 560.000'0),

			ITM(  0.005'55, 3, 1,   0.005'6),
			ITM(  0.055'55, 3, 1,   0.055'6),
			ITM(  0.555'55, 3, 1,   0.556'0),
			ITM(  5.555'55, 3, 1,   5.600'0),
			ITM( 55.555'55, 3, 1,  55.600'0),
			ITM(555.555'55, 3, 1, 556.000'0),

			ITM(  0.005'555'5, 4, 1,   0.005'556),
			ITM(  0.055'555'5, 4, 1,   0.055'600),
			ITM(  0.555'555'5, 4, 1,   0.555'600),
			ITM(  5.555'555'5, 4, 1,   5.556'000),
			ITM( 55.555'555'5, 4, 1,  55.600'000),
			ITM(555.555'555'5, 4, 1, 555.600'000),

			ITM(  0.005'555'55, 5, 1,   0.005'555'6),
			ITM(  0.055'555'55, 5, 1,   0.055'556'0),
			ITM(  0.555'555'55, 5, 1,   0.555'600'0),
			ITM(  5.555'555'55, 5, 1,   5.555'600'0),
			ITM( 55.555'555'55, 5, 1,  55.556'000'0),
			ITM(555.555'555'55, 5, 1, 555.600'000'0),

			ITM(  0.005'555'55, 6, 1,   0.005'555'6),
			ITM(  0.055'555'55, 6, 1,   0.055'555'6),
			ITM(  0.555'555'55, 6, 1,   0.555'556'0),
			ITM(  5.555'555'55, 6, 1,   5.555'600'0),
			ITM( 55.555'555'55, 6, 1,  55.555'600'0),
			ITM(555.555'555'55, 6, 1, 555.556'000'0),

			ITM(  0.005'555, 3, 2,   0.005'56),
			ITM(  0.055'555, 3, 2,   0.055'60),
			ITM(  0.555'555, 3, 2,   0.556'00),
			ITM(  5.555'555, 3, 2,   5.560'00),
			ITM( 55.555'555, 3, 2,  55.600'00),
			ITM(555.555'555, 3, 2, 556.000'00),

			ITM(  0.005'555'5, 4, 2,   0.005'556),
			ITM(  0.055'555'5, 4, 2,   0.055'560),
			ITM(  0.555'555'5, 4, 2,   0.555'600),
			ITM(  5.555'555'5, 4, 2,   5.556'000),
			ITM( 55.555'555'5, 4, 2,  55.560'000),
			ITM(555.555'555'5, 4, 2, 555.600'000),

			ITM(  0.005'555'55, 5, 2,   0.005'555'6),
			ITM(  0.055'555'55, 5, 2,   0.055'556'0),
			ITM(  0.555'555'55, 5, 2,   0.555'560'0),
			ITM(  5.555'555'55, 5, 2,   5.555'600'0),
			ITM( 55.555'555'55, 5, 2,  55.556'000'0),
			ITM(555.555'555'55, 5, 2, 555.560'000'0),

			ITM(  0.005'555'555, 6, 2,   0.005'555'56),
			ITM(  0.055'555'555, 6, 2,   0.055'555'60),
			ITM(  0.555'555'555, 6, 2,   0.555'556'00),
			ITM(  5.555'555'555, 6, 2,   5.555'560'00),
			ITM( 55.555'555'555, 6, 2,  55.555'600'00),
			ITM(555.555'555'555, 6, 2, 555.556'000'00),
#	undef ITM
		};
