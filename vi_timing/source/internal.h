...
namespace misc
{
	constexpr unsigned build_number_updater(const char (&date)[12], const char (&time)[9]); // Converts the date and time to a monotonically increasing number. Stores it in BUILD_NUMBER.
