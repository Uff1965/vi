...
#	define ITM(E, precition, dec, expected) {__LINE__, 5.555555555555e##E, expected, precition, dec}
			ITM(-3, 1, 0,   0.006),
			ITM(-2, 1, 0,   0.060),
			ITM(-1, 1, 0,   0.600),
			ITM( 0, 1, 0,   6.000),
			...
			ITM( 0, 4, 1,   5.556000),
			ITM( 1, 4, 1,  55.600000),
			ITM( 2, 4, 1, 555.600000),

			ITM(-3, 5, 1,   0.0055556),
			ITM(-2, 5, 1,   0.0555560),
			ITM(-1, 5, 1,   0.5556000),
			ITM( 0, 5, 1,   5.5556000),
			ITM( 1, 5, 1,  55.5560000),
			ITM( 2, 5, 1, 555.6000000),

			ITM(-3, 6, 1,   0.0055556),
			ITM(-2, 6, 1,   0.0555556),
			ITM(-1, 6, 1,   0.5555560),
			ITM( 0, 6, 1,   5.5556000),
			ITM( 1, 6, 1,  55.5556000),
			ITM( 2, 6, 1, 555.5560000),
			...
			ITM( 0, 4, 2,   5.556000),
			ITM( 1, 4, 2,  55.560000),
			ITM( 2, 4, 2, 555.600000),

			ITM(-3, 5, 2,   0.0055556),
			ITM(-2, 5, 2,   0.0555560),
			ITM(-1, 5, 2,   0.5555600),
			ITM( 0, 5, 2,   5.5556000),
			ITM( 1, 5, 2,  55.5560000),
			ITM( 2, 5, 2, 555.5600000),

			ITM(-3, 6, 2,   0.00555556),
			ITM(-2, 6, 2,   0.05555560),
			ITM(-1, 6, 2,   0.55555600),
			ITM( 0, 6, 2,   5.55556000),
			ITM( 1, 6, 2,  55.55560000),
			ITM( 2, 6, 2, 555.55600000),
#	undef ITM
		};
